//  Convert of JSON file (latest.cpuprofile) to TypeScript code
//
...
const typeMap: any = {
    "Welcome": o([
        { json: "traceEvents", js: "traceEvents", typ: a(r("TraceEvent")) },
        { json: "samples", js: "samples", typ: a(r("Sample")) },
        { json: "stackFrames", js: "stackFrames", typ: m(r("StackFrame")) },
    ], false),
    "Sample": o([
        { json: "cpu", js: "cpu", typ: "" },
    ...
    "StackFrame": o([
        ...
        { json: "funcLine", js: "funcLine", typ: u(undefined, "") },
        { json: "funcColumn", js: "funcColumn", typ: u(undefined, "") },
        { json: "name", js: "name", typ: "" },
